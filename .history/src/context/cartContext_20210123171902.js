...
const CarritoProvider = ({children}) => {
  ...
  return (
    <Provider value={{onAdd, cargarItem, cantidadProducto, quitarDelCarrito, total, vaciarCarrito, carrito, cantidad, nombre, setNombre, telefono, setTelefono,email, setEmail}}>
      {children}
    </Provider>
  );
};

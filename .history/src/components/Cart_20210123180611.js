...
const Cart = () => {
    ...
    const {carrito, total, quitarDelCarrito, vaciarCarrito, nombre, setNombre, telefono, setTelefono, email, setEmail,compra, setCompraconfirmarCompra} = useContext(contexto);

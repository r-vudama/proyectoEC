            ...
            {carrito.length === 0 ? '' :            
                <form onSubmit={confirmarCompra} className="form-compra">
                    <div className="input-form">
                        <input value={nombre} placeholder="Nombre*" req onChange={(e)=>{setNombre(e.target.value)}} type="text"/>
                    </div>
                    <div className="input-form">
                        <input value={telefono} placeholder="Teléfono*" req onChange={(e)=>{setTelefono(e.target.value)}} type="text"/>
                    </div>
                    <div className="input-form">
                        <input value={email} placeholder="E-mail*" req onChange={(e)=>{setEmail(e.target.value)}} type="email"/>
                    </div>
